...
function App() {
  // STATE MANAGEMENT
  const [showWelcome, setShowWelcome] = useState(true); // Controls the Welcome Screen
  ...
  return (
    <>
      ...
      {/* 2. MAIN APP CONTENT (Hidden until Start is clicked) */}
      {!showWelcome && (
        <div className={`min-vh-100 bg-light p-3 position-relative overflow-hidden ${isResetting ? 'animate-flash' : ''} ${theme === 'dark' ? 'dark-mode' : ''}`}>
                ...
                <div className="card shadow-lg border-0 rounded-4"> 
                  ...
                  <div className="card-header bg-primary text-white py-4 rounded-top-4 position-relative">
                    <div className="text-center">
                      ...
                      <small className="opacity-75">Free & Unlimited Generation</small>
                    </div>
                    ...
                    <button 
                      ...
                      className="btn btn-light position-absolute top-50 end-0 translate-middle-y me-4 fw-bold shadow-sm d-flex align-items-center gap-2 px-4 py-2"
                    >
                    ...
                    <div className="row g-5">
                      ...
                      <div className="col-md-6 d-flex flex-column">
                        ...
                        <TextareaAutosize
                          ...
                          placeholder="E.g., An astronaut riding a horse on Mars, realistic 8k..."
                          value={prompt}
                  ...
                  <div className="card-footer bg-transparent border-0 text-center pb-4 pt-0">
                    <small className="text-muted opacity-50">
                      © 2026 <strong>Ravindu Kaveesha</strong>. All rights reserved.
                    </small>
                  </div>
